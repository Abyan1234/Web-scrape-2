...
time.sleeep(10)
headers=["star","constellation","right_ascension","declination","app._mag.","distance(ly)","spectral_type","brown_dwarf","mass(mj)","radius(rj)","orbital_period(d)","semimajor_axis(au)","ecc."]
dwarf_data=[]
new_dwarf_data=[]
